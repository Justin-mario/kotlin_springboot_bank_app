...
class BankController(private val service: BankService) {
    ...
    fun handleAlreadyExistException(e: IllegalArgumentException): ResponseEntity<String> = ResponseEntity(e.message, HttpStatus.BAD_REQUEST)
    ...
    fun deleteBank(@PathVariable accountNumber: String): String = service.deleteBank(accountNumber)
